                    ...
                    <div class="normal-table-list mg-t-30">
                        ...
                        <div class="bsc-tbl-hvr">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <?php
                                    $sel_artists = "SELECT * FROM artists INNER JOIN social_media_links ON social_media_links.artist_id = artists.artist_id ORDER BY artist_name ASC";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small><?php echo $row['artist_smart_url'] ?></small>
                                            </td>
                                            <td><?php echo $row['artist_bio'] ?></td>
                                            <td>
                                                <a href="<?php echo $row['sml_whatsapp'] ?>">Whatsapp |</a>
                                                <a href="<?php echo $row['sml_facebook'] ?>"> Facebook |</a>
                                                <a href="<?php echo $row['sml_twitter'] ?>"> Twitter |</a>
                                                <a href="<?php echo $row['sml_instagram'] ?>"> Instagram |</a>
                                                <a href="<?php echo $row['sml_youtube'] ?>"> Youtube</a>
                                            </td>
