<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_sml = "UPDATE social_media_links SET sml_whatsapp = '$sml_whatsapp', sml_facebook = '$sml_facebook', sml_twitter = '$sml_twitter', sml_instagram = '$sml_instagram', sml_youtube = '$sml_youtube' WHERE artist_id = '$artist_id'";
...
<?php
    ...
    $query_artist = "SELECT * FROM artists, social_media_links WHERE social_media_links.artist_id = artists.artist_id AND artists.artist_id = '$artist_id' LIMIT 1";
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="form-group ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" name="artist_smart_url" class="form-control" data-mask="999.999.999.9999" value="<?php echo $row['artist_smart_url'] ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12"><br>
                                    ...
                                    <div class="form-group ic-cmp-int form-elet-mg">
                                        ...
                                        <div class="nk-int-st">
                                            <textarea name="artist_bio" class="form-control" cols="10" rows="5" placeholder="about artist" readonly><?php echo $row['artist_bio'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
