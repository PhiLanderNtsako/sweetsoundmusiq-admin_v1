                    ...
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                <?php
                                    $sel_songs = "SELECT * FROM musiq, artists WHERE musiq.artist_id = artists.artist_id ORDER BY musiq_id DESC";
                                    $query_songs = mysqli_query($conn, $sel_songs);

                                    while($row = mysqli_fetch_array($query_songs)){
                                ?>
                                        <tr>
                                            <td>
                                                <img src="../musiq/images/musiq_images/<?php echo $row['musiq_coverart'] ?>" alt="" width ="180px">
                                            </td>
                                            <td><?php echo $row['artist_name'] ?></td>
                                            <td>
                                            <?php
                                                echo $row['musiq_title'];
                                            ...
                                            <td width="10px">
                                                <?php echo $row['page_views'] ?><br>
                                                <a href="../musiq/<?php echo $row['artist_smart_url'].'/'.$row['musiq_smart_url'] ?>">https://www.sweetsound.co.za/musiq/<?php echo $row['artist_smart_url'].'/'.$row['musiq_smart_url'] ?></a>
                                            </td>
                                            <td>
                                            <?php
                                                if($row['active_yn']){
